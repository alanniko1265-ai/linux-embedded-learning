...
int main(void){
    ...
    printf("connected to epoll protocol server\n");
    ...
    while(1){
        ...
        ssize_t n=read_message(client_fd,response,sizeof(response));
        if(n<0){
