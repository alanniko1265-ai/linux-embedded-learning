...
基于 i.MX6ULL 的 Linux 虚拟车载传感器驱动与交互实验台。
...
| 6 | 板载按键产生碰撞事件，LED显示状态 | input/GPIO、软硬件联调 | 中高 |
...
先阅读 [docs/prerequisite_guide.md](./docs/prerequisite_guide.md)，再执行 [docs/day55_start.md](./docs/day55_start.md)。Day55 只完成环境核验和第一个模块闭环，不修改设备树，也不碰真实传感器。
